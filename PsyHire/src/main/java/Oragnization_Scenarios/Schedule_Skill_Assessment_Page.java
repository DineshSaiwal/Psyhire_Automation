...
public class Schedule_Skill_Assessment_Page {
	WebDriver driver = Base_Class.getDriver();
		...
		@FindBy(xpath = "//button[contains(text(),'Skill Assessment')]")
		private WebElement Select_Skill_Assessment;
		public void Select_Skill_Assessment() 
		{Select_Skill_Assessment.click();}
		...
		@FindBy(xpath = "(//span[contains(text(),'Re-schedule')])[2]")
		...
		public Schedule_Skill_Assessment_Page(WebDriver driver) {
